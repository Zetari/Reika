exports.run = (bot) => {
	...
	const statuses = [
		...
		{ type: 3, name: 'Netflix' },
		{ type: 3, name: 'you' },
		{ type: 3, name: `over ${bot.users.size} users` },
		{ type: 3, name: 'zetari#0001' },
		{ type: 0, name: '<3' },
		{ type: 3, name: 'the sky go past' },
		{ type: 3, name: 'the sun go down' },
		{ type: 3, name: 'the sunrise' },
		{ type: 3, name: 'youtube videos' },
		{ type: 0, name: 'CS:GO' },
	];
